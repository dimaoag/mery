...
class MainController extends AppController
{
    ...
    public function indexAction(){
        ...
        $reviews = \R::getAll("SELECT review.*, user.first_name, user.last_name, user.photo_profile FROM review JOIN user ON review.user_id = user.id WHERE review.status = 1 LIMIT 7");
